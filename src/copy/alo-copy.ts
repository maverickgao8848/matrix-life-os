...
// 规则：精简至上，降低认知负荷，保留黑色幽默。

export const aloCopy = {
  // ── Empty State Messages ──
  emptyStates: {
    inbox: "收纳箱空空如也——或者你只是把所有事都拖到了‘明天’。",
    weekBoardColumn: "暂无任务。一片空白，就像你对今天下午的规划。",
    reflectionLibrary: "暂无反思。你花了 0 秒审视今天，这意味着今天和昨天没有区别。",
    abilityTracker: "尚未创建能力。雷达图是一片纯洁的虚无，某种意义上也是天赋。",
    entertainment: "今天还没有娱乐活动。你是机器人吗？如果是，请跳过此提示。",
    habitTracker: "暂无习惯。习惯是复利，你的本金是零。起步永远不晚，但确实越来越贵。",
    moodTracker: "暂无情绪记录。你的内心是一团无法解析的混沌——记下来会清楚一点？",
    timeBlock: "今天的时间块一片空白。时间正在以每秒一秒的速度逃离你。",
    inspirationVault: "灵感仓库空空如也。灵感不会拜访不工作的人。",
    okr: "暂无目标。没有方向的努力叫挣扎，有方向的才叫前进。你属于前者。",
    keyResults: "暂无关键结果。目标没有结果，就像烧烤没有调料——本质还是生的。",
    radar: "暂无能力数据，雷达图无法生成。你的自我认知是黑洞，连光都逃不出去。",
    reflectionTemplate: "暂无可用模板。你连拷问自己的工具都没准备好，难怪逃避得这么顺利。",
    abilityManagement: "暂无能力。培养计划处于‘尚未发生’的量子态，观察一下就会坍缩。",
  },

  // ── Tutorial / Tooltip Messages ──
  tooltips: {
    dragReorder: "拖拽调整优先级。如果拖不动，可能是你的决心还不够重。",
    abilityScoring: "勾选完成的任务会自动累计能力分数。progress is silent，但雷达图会大声出卖你。",
  ...
  nav: {
    actionDeskHover: "收集、执行、推进。",
    reviewArchiveHover: "记录不是为了完美，是为了证明今天发生过。",
    systemHover: "备份、更新、毒舌语录。",
    moduleHover: "关掉不看的模块，节省像素给愧疚感。",
    themeHover: "黑暗模式适合深夜自我感动。",
  },
  ...
  monologues: {
    emptyBoard: [
      ...
      "0 个任务。软件此刻比你更清楚：你打开它只是为了缓解焦虑。",
      "一片空白的周计划，配上一颗空白的大脑。至少很搭。",
    ],
    streakBroken: [
      "连续 {days} 天没写反思。你的‘坚持’像冰激凌一样融化了，而且没人给你再买一根。",
      "断更 {days} 天。软件不会生气，它只是默默把你的连续记录归零，像什么都没发生过。",
    ],
    lateNight: [
      "凌晨了还在看任务板。你不是在规划明天，你是在用‘准备’逃避‘睡觉’。",
